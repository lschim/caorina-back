...
public record DrugCreationCmd(
  ...
  public static class Builder {
    ...
    public Builder chineseName(String chineseName) { this.chineseName = chineseName; return this; }
    public Builder alternativeChineseNames(List<String> names) { this.alternativeChineseNames = names; return this; }
    public Builder latinName(String latinName) { this.latinName = latinName; return this; }
    public Builder frenchName(String frenchName) { this.frenchName = frenchName; return this; }
    public Builder nature(DrugNature nature) { this.nature = nature; return this; }
    public Builder flavors(List<DrugFlavor> flavors) { this.flavors = flavors; return this; }
    public Builder tropism(List<Organ> tropism) { this.tropism = tropism; return this; }
    public Builder movements(List<DrugMovement> movements) { this.movements = movements; return this; }
    public Builder primaryCategoryId(Long id) { this.primaryCategoryId = id; return this; }
    public Builder contraindications(List<String> contraindications) { this.contraindications = contraindications; return this; }
    ...
    public Builder numberOfStars(Integer stars) { this.numberOfStars = stars; return this; }
