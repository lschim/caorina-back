...
\restrict Frifn3Gb4OQdKoOJN1TjcnmSwJZ7pUgBQ0LekaLT5Fw1bQZcINp4tUshb7UVGjw
...
--
-- Name: alternative_names; Type: TABLE; Schema: public; Owner: tcm-assistant
--
...
ALTER TABLE public.alternative_names OWNER TO "tcm-assistant";

--
-- Name: drug_association; Type: TABLE; Schema: public; Owner: tcm-assistant
--

CREATE TABLE public.drug_association (
    id bigint NOT NULL,
    drug_id bigint,
    associated_drug_id bigint
);


ALTER TABLE public.drug_association OWNER TO "tcm-assistant";

--
-- Name: drug_association_effects; Type: TABLE; Schema: public; Owner: tcm-assistant
--

CREATE TABLE public.drug_association_effects (
    association_id bigint NOT NULL,
    effect character varying(255)
);


ALTER TABLE public.drug_association_effects OWNER TO "tcm-assistant";

--
-- Name: drug_association_id_seq; Type: SEQUENCE; Schema: public; Owner: tcm-assistant
--

ALTER TABLE public.drug_association ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.drug_association_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: drug_category; Type: TABLE; Schema: public; Owner: tcm-assistant
--
...
ALTER TABLE public.drug_category OWNER TO "tcm-assistant";

--
-- Name: drug_category_id_seq; Type: SEQUENCE; Schema: public; Owner: tcm-assistant
--

ALTER TABLE public.drug_category ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME public.drug_category_id_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
--
-- Name: drug_contraindications; Type: TABLE; Schema: public; Owner: tcm-assistant
--

CREATE TABLE public.drug_contraindications (
    drug_id bigint NOT NULL,
    contraindication character varying(1000)
);


ALTER TABLE public.drug_contraindications OWNER TO "tcm-assistant";

--
-- Name: drug_effects; Type: TABLE; Schema: public; Owner: tcm-assistant
--

CREATE TABLE public.drug_effects (
    drug_id bigint NOT NULL,
    effect character varying(1000)
);


ALTER TABLE public.drug_effects OWNER TO "tcm-assistant";

--
-- Name: drug_flavors; Type: TABLE; Schema: public; Owner: tcm-assistant
--

CREATE TABLE public.drug_flavors (
    drug_id bigint NOT NULL,
    flavor character varying(255),
    CONSTRAINT drug_flavors_flavor_check CHECK (((flavor)::text = ANY ((ARRAY['SOUR'::character varying, 'BITTER'::character varying, 'SWEET'::character varying, 'PUNGENT'::character varying, 'SALTY'::character varying, 'BLAND'::character varying, 'AROMATIC'::character varying])::text[])))
);


ALTER TABLE public.drug_flavors OWNER TO "tcm-assistant";

--
-- Name: drug_movement; Type: TABLE; Schema: public; Owner: tcm-assistant
--

CREATE TABLE public.drug_movement (
    drug_id bigint NOT NULL,
    movements character varying(255),
    CONSTRAINT drug_movement_movements_check CHECK (((movements)::text = ANY ((ARRAY['ASCENDING'::character varying, 'DESCENDING'::character varying, 'OUTWARD'::character varying, 'INWARD'::character varying])::text[])))
);


ALTER TABLE public.drug_movement OWNER TO "tcm-assistant";

--
-- Name: drug_tropism; Type: TABLE; Schema: public; Owner: tcm-assistant
--

CREATE TABLE public.drug_tropism (
    drug_id bigint NOT NULL,
    tropism character varying(255),
    CONSTRAINT drug_tropism_tropism_check CHECK (((tropism)::text = ANY ((ARRAY['LIVER'::character varying, 'GALLBLADDER'::character varying, 'HEART'::character varying, 'SMALL_INTESTINE'::character varying, 'SPLEEN'::character varying, 'STOMACH'::character varying, 'LUNGS'::character varying, 'LARGE_INTESTINE'::character varying, 'KIDNEYS'::character varying, 'BLADDER'::character varying, 'PERICARDIUM'::character varying, 'TRIPLE_BURNER'::character varying])::text[])))
);


ALTER TABLE public.drug_tropism OWNER TO "tcm-assistant";

--
-- Name: drugs; Type: TABLE; Schema: public; Owner: tcm-assistant
--
...
CREATE TABLE public.drugs (
    ...
    french_name character varying(255),
    nature character varying(255),
    dosage character varying(255),
    number_of_stars integer,
    additional_notes character varying(1000),
    category_id bigint,
    chinese_characters character varying(255),
    CONSTRAINT drugs_nature_check CHECK (((nature)::text = ANY ((ARRAY['HOT'::character varying, 'WARM'::character varying, 'NEUTRAL'::character varying, 'COOL'::character varying, 'COLD'::character varying])::text[])))
);


ALTER TABLE public.drugs OWNER TO "tcm-assistant";

--
-- Name: drugs_id_seq; Type: SEQUENCE; Schema: public; Owner: tcm-assistant
--
...
--
-- Name: flyway_schema_history; Type: TABLE; Schema: public; Owner: tcm-assistant
--
...
ALTER TABLE public.flyway_schema_history OWNER TO "tcm-assistant";

--
-- Data for Name: alternative_names; Type: TABLE DATA; Schema: public; Owner: tcm-assistant
--

COPY public.alternative_names (drug_id, name) FROM stdin;
384	Hai piao xiao
\.


--
-- Data for Name: drug_association; Type: TABLE DATA; Schema: public; Owner: tcm-assistant
--

COPY public.drug_association (id, drug_id, associated_drug_id) FROM stdin;
1	1	45
2	1	204
3	1	95
4	1	342
...
--
-- Data for Name: drug_association_effects; Type: TABLE DATA; Schema: public; Owner: tcm-assistant
--

COPY public.drug_association_effects (association_id, effect) FROM stdin;
...
--
-- Data for Name: drug_category; Type: TABLE DATA; Schema: public; Owner: tcm-assistant
--

COPY public.drug_category (id, name, description) FROM stdin;
...
--
-- Data for Name: drug_contraindications; Type: TABLE DATA; Schema: public; Owner: tcm-assistant
--

COPY public.drug_contraindications (drug_id, contraindication) FROM stdin;
...
--
-- Data for Name: drug_effects; Type: TABLE DATA; Schema: public; Owner: tcm-assistant
--

COPY public.drug_effects (drug_id, effect) FROM stdin;
...
--
-- Data for Name: drug_flavors; Type: TABLE DATA; Schema: public; Owner: tcm-assistant
--

COPY public.drug_flavors (drug_id, flavor) FROM stdin;
1	SWEET
2	SWEET
2	PUNGENT
2	BLAND
...
--
-- Data for Name: drug_movement; Type: TABLE DATA; Schema: public; Owner: tcm-assistant
--

COPY public.drug_movement (drug_id, movements) FROM stdin;
1	INWARD
1	DESCENDING
2	DESCENDING
2	INWARD
...
--
-- Data for Name: drug_tropism; Type: TABLE DATA; Schema: public; Owner: tcm-assistant
--

COPY public.drug_tropism (drug_id, tropism) FROM stdin;
1	LUNGS
1	LIVER
1	LARGE_INTESTINE
2	HEART
...
--
-- Data for Name: drugs; Type: TABLE DATA; Schema: public; Owner: tcm-assistant
--

COPY public.drugs (id, chinese_name, latin_name, french_name, nature, dosage, number_of_stars, additional_notes, category_id, chinese_characters) FROM stdin;
...
--
-- Data for Name: flyway_schema_history; Type: TABLE DATA; Schema: public; Owner: tcm-assistant
--

COPY public.flyway_schema_history (installed_rank, version, description, type, script, checksum, installed_by, installed_on, execution_time, success) FROM stdin;
1	1	init	SQL	V1__init.sql	72771926	tcm-assistant	2026-05-17 14:59:35.297998	56	t
2	2	add chinese characters to drug	SQL	V2__add_chinese_characters_to_drug.sql	1597446090	tcm-assistant	2026-05-17 15:24:28.611575	6	t
3	3	seed categories	SQL	V3__seed_categories.sql	447739040	tcm-assistant	2026-05-17 17:23:12.944991	34	t
4	4	seed drugs	SQL	V4__seed_drugs.sql	-745258276	tcm-assistant	2026-05-17 17:23:12.997913	1114	t
5	5	seed associations	SQL	V5__seed_associations.sql	583995639	tcm-assistant	2026-05-17 17:23:14.263966	808	t
6	6	clean category names	SQL	V6__clean_category_names.sql	1870453266	tcm-assistant	2026-05-17 17:28:13.784951	18	t
7	7	add missing drugs	SQL	V7__add_missing_drugs.sql	414446426	tcm-assistant	2026-05-17 17:39:31.856602	18	t
8	8	fix unknown category	SQL	V8__fix_unknown_category.sql	433515111	tcm-assistant	2026-05-18 10:49:51.001116	44	t
9	9	fix association yao suffix	SQL	V9__fix_association_yao_suffix.sql	-720989869	tcm-assistant	2026-05-18 19:53:37.554219	33	t
10	10	fix association alternate names	SQL	V10__fix_association_alternate_names.sql	-617852019	tcm-assistant	2026-05-18 20:50:36.022956	48	t
11	11	seed new drugs	SQL	V11__seed_new_drugs.sql	517374043	tcm-assistant	2026-05-18 20:50:36.091432	128	t
12	12	fix alias associations	SQL	V12__fix_alias_associations.sql	-1912489051	tcm-assistant	2026-05-18 23:20:24.848938	114	t
13	13	seed jing jie	SQL	V13__seed_jing_jie.sql	1978022991	tcm-assistant	2026-05-18 23:39:29.066614	44	t
14	14	seed man jing zi	SQL	V14__seed_man_jing_zi.sql	341226174	tcm-assistant	2026-05-18 23:50:53.855703	15	t
15	15	seed wei ling xian	SQL	V15__seed_wei_ling_xian.sql	944335648	tcm-assistant	2026-05-20 00:16:52.772259	36	t
16	16	seed xu chang qing can sha shen jin cao	SQL	V16__seed_xu_chang_qing_can_sha_shen_jin_cao.sql	517885841	tcm-assistant	2026-05-20 00:16:52.82568	13	t
17	17	fix bai dou kou category	SQL	V17__fix_bai_dou_kou_category.sql	542795306	tcm-assistant	2026-05-20 00:25:38.331676	6	t
\.


--
-- Name: drug_association_id_seq; Type: SEQUENCE SET; Schema: public; Owner: tcm-assistant
--

SELECT pg_catalog.setval('public.drug_association_id_seq', 1293, true);


--
-- Name: drug_category_id_seq; Type: SEQUENCE SET; Schema: public; Owner: tcm-assistant
--

SELECT pg_catalog.setval('public.drug_category_id_seq', 46, true);


--
-- Name: drugs_id_seq; Type: SEQUENCE SET; Schema: public; Owner: tcm-assistant
--

SELECT pg_catalog.setval('public.drugs_id_seq', 401, true);


--
-- Name: drug_association drug_association_drug_id_associated_drug_id_key; Type: CONSTRAINT; Schema: public; Owner: tcm-assistant
--

ALTER TABLE ONLY public.drug_association
    ADD CONSTRAINT drug_association_drug_id_associated_drug_id_key UNIQUE (drug_id, associated_drug_id);


--
-- Name: drug_association drug_association_pkey; Type: CONSTRAINT; Schema: public; Owner: tcm-assistant
--

ALTER TABLE ONLY public.drug_association
    ADD CONSTRAINT drug_association_pkey PRIMARY KEY (id);


--
-- Name: drug_category drug_category_pkey; Type: CONSTRAINT; Schema: public; Owner: tcm-assistant
--
...
--
-- Name: drugs drugs_chinese_name_key; Type: CONSTRAINT; Schema: public; Owner: tcm-assistant
--

ALTER TABLE ONLY public.drugs
    ADD CONSTRAINT drugs_chinese_name_key UNIQUE (chinese_name);


--
-- Name: drugs drugs_pkey; Type: CONSTRAINT; Schema: public; Owner: tcm-assistant
--
...
--
-- Name: flyway_schema_history flyway_schema_history_pk; Type: CONSTRAINT; Schema: public; Owner: tcm-assistant
--
...
--
-- Name: flyway_schema_history_s_idx; Type: INDEX; Schema: public; Owner: tcm-assistant
--
...
--
-- Name: alternative_names alternative_names_drug_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: tcm-assistant
--

ALTER TABLE ONLY public.alternative_names
    ADD CONSTRAINT alternative_names_drug_id_fkey FOREIGN KEY (drug_id) REFERENCES public.drugs(id);


--
-- Name: drug_association drug_association_associated_drug_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: tcm-assistant
--

ALTER TABLE ONLY public.drug_association
    ADD CONSTRAINT drug_association_associated_drug_id_fkey FOREIGN KEY (associated_drug_id) REFERENCES public.drugs(id);


--
-- Name: drug_association drug_association_drug_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: tcm-assistant
--

ALTER TABLE ONLY public.drug_association
    ADD CONSTRAINT drug_association_drug_id_fkey FOREIGN KEY (drug_id) REFERENCES public.drugs(id);


--
-- Name: drug_association_effects drug_association_effects_association_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: tcm-assistant
--

ALTER TABLE ONLY public.drug_association_effects
    ADD CONSTRAINT drug_association_effects_association_id_fkey FOREIGN KEY (association_id) REFERENCES public.drug_association(id);


--
-- Name: drug_contraindications drug_contraindications_drug_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: tcm-assistant
--

ALTER TABLE ONLY public.drug_contraindications
    ADD CONSTRAINT drug_contraindications_drug_id_fkey FOREIGN KEY (drug_id) REFERENCES public.drugs(id);


--
-- Name: drug_effects drug_effects_drug_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: tcm-assistant
--

ALTER TABLE ONLY public.drug_effects
    ADD CONSTRAINT drug_effects_drug_id_fkey FOREIGN KEY (drug_id) REFERENCES public.drugs(id);


--
-- Name: drug_flavors drug_flavors_drug_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: tcm-assistant
--

ALTER TABLE ONLY public.drug_flavors
    ADD CONSTRAINT drug_flavors_drug_id_fkey FOREIGN KEY (drug_id) REFERENCES public.drugs(id);


--
-- Name: drug_movement drug_movement_drug_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: tcm-assistant
--

ALTER TABLE ONLY public.drug_movement
    ADD CONSTRAINT drug_movement_drug_id_fkey FOREIGN KEY (drug_id) REFERENCES public.drugs(id);


--
-- Name: drug_tropism drug_tropism_drug_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: tcm-assistant
--

ALTER TABLE ONLY public.drug_tropism
    ADD CONSTRAINT drug_tropism_drug_id_fkey FOREIGN KEY (drug_id) REFERENCES public.drugs(id);


--
-- Name: drugs drugs_category_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: tcm-assistant
--

ALTER TABLE ONLY public.drugs
    ADD CONSTRAINT drugs_category_id_fkey FOREIGN KEY (category_id) REFERENCES public.drug_category(id);
...
\unrestrict Frifn3Gb4OQdKoOJN1TjcnmSwJZ7pUgBQ0LekaLT5Fw1bQZcINp4tUshb7UVGjw
